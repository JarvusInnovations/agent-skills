...
patterns to converge on — distilled from the CBL apps' 2016–2023 evolution and the best
of SlateAdmin — plus a per-file audit and cleanup playbook for SlateAdmin itself.

## When you'd want it

Any work on the legacy Slate ExtJS apps: fixing bugs, stabilizing screens, cleaning up
state/component jank, or extending an existing screen. The guidance keeps agents from
improvising against the grain — or "modernizing" toward framework features these apps
